...
import me.pharmacy.model.SalesStatics;
 ...
 public interface CustomerRepository extends CrudRepository<Customer,Integer>{
     ...
     @Query(value=" SELECT SUM(a.from_cashback) totalFromCashback , SUM(a.total_price) totalSales ,SUM(a.payment) totalCollection,SUM(a.cash_Back_Amount) totalCashBack,SUM(a.total_price-(a.total_price*(a.comision/100))) as totalSalesValue , SUM(a.total_price*(a.comision/100)) as totalComisionValue ,SUM((a.total_price-(a.total_price*(a.comision/100))-a.payment)) as totalDueValue ,:startDate as date FROM Customer a WHERE a.created_at BETWEEN :startDate AND :endDate AND  a.is_delete=0 ",nativeQuery =true)
